...
const studentBestGrade = estudantes.map((student) => (
  {
  name: student.nome,
  nota: student.materias.reduce((result, grade) => ((result.nota > grade.nota) ? result : grade)).name,
  }
))
console.log(studentBestGrade);